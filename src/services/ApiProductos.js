//Importo Factory
import FactoryProductosDAO from '../model/DAOs/productos/FactoryProductosDAO.js';
...
class ApiProductos {
    ...
    createProduct = async (prod) => {
        ...
        //Primero valido que lo recibido sea un producto bien formado
        if (ApiProductos.isProducto(prod)) {
            ...
            throw { errCode: -5, errDescription: 'Bad Product Body. Estructura esperada: {nombre, descripcion, codigo, thumbnail, precio, stock}' }
        }
    }
    ...
    // TODO: quizás deba evaluar el uso de joi en el model como reemplazo de esta validación...
    static isProducto(obj) {
        if (obj &&
